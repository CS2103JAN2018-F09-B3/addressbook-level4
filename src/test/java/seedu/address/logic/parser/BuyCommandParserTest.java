...
public class BuyCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() throws Exception {
        String commandString = buildCommandString(INDEX_AS_STRING, AMOUNT_PREFIX.toString(), INT_AS_STRING);
        Command command = constructBuyCommand(INDEX_AS_STRING, INT_AS_STRING);
        assertParseSuccess(parser, commandString, command);
        commandString = buildCommandString(INDEX_AS_STRING, AMOUNT_PREFIX.toString(), FLOAT_AS_STRING);
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        commandString = buildCommandString(INDEX_AS_STRING, AMOUNT_PREFIX.toString());
        assertParseFailure(parser, commandString, expectedMessage);
    }
    ...
    public void parse_invalidValue_failure() {
        ...
        // invalid prefix
        String commandString = buildCommandString(INDEX_AS_STRING, NAME_PREFIX.toString(), INDEX_AS_STRING);
        assertParseFailure(parser, commandString, expectedMessage);

        // invalid value
        commandString = buildCommandString(INDEX_AS_STRING, NAME_PREFIX.toString(), INVALID_VALUE_AS_STRING);
        assertParseFailure(parser, commandString, expectedMessage);

        // empty preamble
        commandString = buildCommandString(NAME_PREFIX.toString(), INT_AS_STRING);
        assertParseFailure(parser, commandString, expectedMessage);
    }
}
