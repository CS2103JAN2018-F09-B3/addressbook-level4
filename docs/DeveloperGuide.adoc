...
1. Search enhancement (Major): Adding SQL-like queries with logical operators as well as additional search specificiers besides name, such as tags and price. +

2. Fetch news (Minor): Fetches news related to crypto currencies from sources such as RSS feeds. +
