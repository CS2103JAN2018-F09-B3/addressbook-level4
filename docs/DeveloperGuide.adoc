...
The autocomplete mechanism is facilitated by `TextFields`, which is part of the ControlsFX library. It supports the predicting of a word or phrase that the user may type based on a partial text query.
